...
options a specific command accepts."""
    ...
    param_kernel_acc = (
        "Specify the type of accelerator to use for the kernel run (e.g. 'NvidiaTeslaT4', "
        "'NvidiaTeslaT4Highmem' for GPU T4 x2, or 'TpuV5E8' for TPU v5e-8). Retired accelerators such as "
